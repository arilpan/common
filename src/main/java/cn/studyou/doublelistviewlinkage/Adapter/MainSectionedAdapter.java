...
import com.ydxiaoyuan.common.R;
...
public class MainSectionedAdapter extends SectionedBaseAdapter {
    ...
    public View getItemView(final int section, final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            layout = (RelativeLayout) inflator.inflate(R.layout.test_menu_select_right_list_item, null);
        } else {
    ...
    public View getSectionHeaderView(int section, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            LayoutInflater inflator = (LayoutInflater) parent.getContext()
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            layout = (LinearLayout) inflator.inflate(R.layout.test_menu_select_header_item, null);
        } else {
